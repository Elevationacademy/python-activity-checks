...
class TestEx3(unittest.TestCase):
    def test_exercise3(self):
      try:
        ...
        inst = Instrument('Percussion', 'Tambourine')
        ...
        assert inst.type == 'Tambourine', f"The 'type' of the instrument was not initialized in the constructor. When passing 'Tambourine' as an argument to the constructor, the type property was initialized to '{inst.type}' - make sure you're using 'self'"
        inst.use()
