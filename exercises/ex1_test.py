...
class TestEx1(unittest.TestCase):
    def __init__(self, *args, **kwargs):
        ...
        self.eval_db = CakesDb("user_cakes_db.sqlite")
        self.eval_query = TestAnswers[0]

    def test_table_exist(self):
        self.user_db.exec_query(actual_query)
    ...
    def test_table_columns(self):
        ...
        actual_names, _ = self.eval_db.select_query(test_query)
